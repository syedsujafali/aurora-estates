    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-6">
      <div className="max-w-md text-center text-cream">
        ...
        <div className="mt-10">
          <Link
            to="/"
            className="ed-link font-mono text-[11px] uppercase tracking-[0.3em] text-oxide"
          >
            Return to the cover →
          </Link>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Allure Properties Group — An Editorial Real Estate Practice" },
      {
        name: "description",
        content:
          "Allure Properties Group is a design-forward, editorial real estate firm curating residences, estates, and sanctuaries with the eye of an architecture studio.",
      },
